          ...
          <div className="flex gap-2 neo-card p-2">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold uppercase transition-all duration-300 ${mode === tab.id
          ...
          <div className="lg:col-span-5">
            ...
            {mode === "REGISTER" && (
              <div className="neo-panel opacity-0 translate-x-[50px] neo-card p-6 bg-[var(--accent-purple)] text-white">
                <h2 className="font-black text-2xl mb-6 text-black">
                  Pendaftaran Wajah Baru 📝
                </h2>

                <div className="space-y-6">
                  <div>
                    <label className="block text-lg font-black mb-2 text-black">NAMA (ID):</label>
                    <input
                      type="text"
                      value={regName}
